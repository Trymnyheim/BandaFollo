    ...
    return (
        <>
            <div id="contact" className="center padding" style={{maxWidth: '900px', margin: 'auto'}} >
                <h1>Kontakt oss</h1>
                <p>Kontakt oss for råd og veiledning, spørsmål om produkter eller om din bestilling.<br/>Du er også hjertelig velkommen i vår butikk!</p>
            </div>
            <div className="container justify-center mb-5">                
                ...
                <Card className="contact-card">
                    <Card.Body>  
                        <Card.Title className="bold" >Bestilling av varer</Card.Title>
                        <p>For bestilling av varer, ta gjerne kontakt på telefon eller sende oss en e-post.</p>
                        <p>Ofte kan det være fint å se og kjenne på varene først, og du er selvfølgelig hjertelig velkommen til vår butikk om du ønsker dette. For utstyr som har behov for tilpassing, kan det være lurt å gi beskjed på forhånd slik at vi er sikker på at vi har god tid til å hjelpe deg med det.</p>
                        <p>
                            Det er også mulig å bestille varer gjennom Bandakjeden's nettbutikk. Hvis du ønsker å handle på nett&nbsp; 
                            <a onClick={handleShowShop} className="link">klikk her.</a>
                        </p>
                        <Shop showShop={showShop} handleCloseShop={handleCloseShop}/>
                    </Card.Body>
                </Card>
                <Hours className="contact-card">
                    <ul>
                        <li>Mandag - Fredag: 09:00 - 17:00</li>
                        <li>Lørdag - Søndag: Stengt</li>
                    </ul>
                    <p>Gjelder for butikken.</p>
                    <p>Telefontid er mellom 09:00 - 16:00</p>
                </Hours>
            </div>
