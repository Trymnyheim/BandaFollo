        ...
        <>
            <div className="footer">
                <div className="footer-item">
                    <img className="logo" src="./src/assets/logo/bandafollo_white.svg"/>
                ...
                <div className="footer-item center">
                    <div className="shop" onClick={handleShowShop} style={{cursor:'pointer'}}>
                        <img style={{width: '60px'}} src="./src/assets/icon/cart.png"/>
                        <Shop showShop={showShop} handleCloseShop={handleCloseShop}/>
                        <br/>
                        <p style={{marginTop: "12px"}}>Handle på nett &rarr;</p>
                    </div>
                </div>
                <div className="footer-item center">
                    <img src="./src/assets/logo/banda.svg" className="banda-logo" />
